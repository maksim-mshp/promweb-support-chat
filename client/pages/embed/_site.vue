            ...
            <v-card color="#fff" class="elevation-10" id="admin_mes">
              <v-form>
                <v-card-actions>
                  ...
                  <v-list-item-content>
                    <v-list-item-title id="adminName"
                      >Константин</v-list-item-title
                    >
                  </v-list-item-content>
                </v-card-actions>
                <v-card-text>
                  ...
                  <v-card-actions>
                    <v-list-item-avatar color="grey darken-3">
                      <v-img
                        class="elevation-10"
                        alt=""
                        src="https://img2.freepng.ru/20180331/eow/kisspng-computer-icons-user-clip-art-user-5abf13db298934.2968784715224718991702.jpg"
                      ></v-img>
                    </v-list-item-avatar>
                    <v-list-item-content>
                      <v-list-item-title id="userName"
                        >Александр</v-list-item-title
                      >
                    </v-list-item-content>
                  </v-card-actions>
                </v-card-actions>
