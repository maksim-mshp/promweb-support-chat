...
// Авторизация админа
Route::get('/login', 'App\Http\Controllers\Messager@login');
// Регистрация админа
...
Route::get('/u/messages', 'App\Http\Controllers\Messager@messagesu');
// Получение всех сообщений для админа. Только Secret
Route::get('/a/messages', 'App\Http\Controllers\Messager@messagesa');
